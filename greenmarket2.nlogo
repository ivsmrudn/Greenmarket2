...
;; to SetFirms объем выпуска (Qmax через QBE) привязан к фикс затратам месяца (ACost), произв. мощности обновляются по исчерпании ресурса
;; условие ухода с рынка ProfitCumulative + 12 * ACost < 0
[
 PriceMean
...
to EcologyTAX
ask firms with [inmarket]
[ set ETAX QM * CostofCleaning / QS ;;;(.1 * Emission) ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
[ set ETAX Qt * CostofCleaning / QSBlack
